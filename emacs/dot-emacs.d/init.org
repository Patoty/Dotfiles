...
** Terminal Stuff
#+begin_src emacs-lisp :tangle no
(defun my/fix-tty-background ()
          (message "hello"))

(add-hook 'after-make-frame-functions #'my/fix-tty-background)
#+end_src
#+begin_src emacs-lisp :tangle no
(defun my-make-terminal-transparent ()
    "Make the terminal background transparent."
      (unless (display-graphic-p)
	    (set-face-attribute 'default t :background "unspecified-bg")))

;; Run this hook after loading the theme
(add-hook 'modus-themes-after-load-theme-hook #'my-make-terminal-transparent)
#+end_src
...
** Set Font
#+begin_src emacs-lisp :tangle yes
(let ((font-size (if (eq system-type 'darwin) 16 12)))
  (add-to-list 'default-frame-alist
               `(font . ,(format "Iosevka Nerd Font-%d" font-size)))
  (add-hook 'after-make-frame-functions
            (lambda (frame)
              (select-frame frame)
              (set-frame-font (format "Iosevka Nerd Font %d" font-size) nil t))))
...
(defcustom project-root-markers
  '("Cargo.lock" "flake.nix" ".git" ".project")
...
(use-package claude-code
  ...
  :bind
  (:repeat-map my-claude-map ("M" . claude-code-cycle-mode)))
#+end_src
* TODO Remote Access
* TODO Gadgets
** Fixme-Mode
...
(use-package org-journal
  ...
  (org-journal-dir "~/Nextcloud/Notes/Journal/")
  (org-journal-date-format "%A, %d %B %Y")
  (org-journal-file-format "%Y-%m.org")
  ;; Each new entry gets a top-level heading with the date
  (org-journal-date-prefix "* ")
  ;; Entries under that are second-level
  (org-journal-time-prefix "** ")
  (org-journal-time-format "%H:%M ")
  (org-journal-enable-agenda-integration t)
  ;; Encrypt if you want privacy (optional)
